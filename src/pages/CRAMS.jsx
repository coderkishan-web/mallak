...
.to(
  ...
  return (
    <>
      ...
      <section
        ref={sectionRef}
        className="flex flex-col-reverse lg:flex-row items-center justify-between px-6 md:px-20 py-20 gap-10 relative"
      >
        <div ref={textRef} className="max-w-xl text-left absolute top-40 right-50">
        ...
        <div
          ref={imageRef}
          className="rounded-xl overflow-hidden shadow-xl transition-all duration-700 w-full"
        >
          <img
            src="src/assets/orange.jpg"
            alt="Chemicals"
      ...
      {/* PLAN Section */}
      <section  className="bg-[#AA8FF7] py-16 px-6 md:px-16 lg:px-32">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between">
          <div className="text-center md:text-left mb-10 md:mb-0">
            <h1 className="text-6xl md:text-7xl font-bold text-black">PLAN &nbsp;&nbsp;&nbsp;&nbsp;</h1>
          </div>
          <div className="w-48 md:w-72 mb-10 md:mb-0">
      ...
      {/* OPTIMIZE Section */}
      <section className="bg-[#8ff794] py-16 px-6 md:px-16 lg:px-32">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between">
          <div className="text-center md:text-left mb-10 md:mb-0">
            <h1 className="text-6xl md:text-7xl font-bold text-black">OPTIMIZE</h1>
          </div>
          <div className="w-48 md:w-72 mb-10 md:mb-0">
      ...
      {/* PRODUCE Section */}
      <section  className="bg-[#6260d4] py-16 px-6 md:px-16 lg:px-32">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between">
          <div className="text-center md:text-left mb-10 md:mb-0">
            <h1 className="text-6xl md:text-7xl font-bold text-black">PRODUCE</h1>
          </div>
          <div className="w-48 md:w-72 mb-10 md:mb-0">
      ...
      <h2 className="text-6xl  text-center mb-20">RESOURCES FOR <br /> REVENUE</h2>
      <div className="flex gap-6 px-6 transition-all duration-500" style={{ height: '400px' }}>
        ...
        >
          ...
          />
          <div className="absolute top-4 left-4 px-6 py-2 bg-gray-300/60 rounded-full text-white font-semibold">Service 1</div>
          <div className="absolute bottom-4 left-4 right-20 bg-black/70 text-white p-4 rounded-xl text-lg font-semibold">
            Enhancing durability, color vibrancy, and performance with advanced pigments
          </div>
          <div className="absolute bottom-4 right-4 bg-white text-black p-4 rounded-full">
        ...
        >
          <img
            ...
            className="object-cover w-full h-full"
          />
          <div className="absolute top-4 left-4 px-6 py-2 bg-cyan-400/60 rounded-full text-white font-semibold">Service 2</div>
           <div className="absolute bottom-4 left-4 right-20 bg-black/70 text-white p-4 rounded-xl text-lg font-semibold">
            Enhancing durability, color vibrancy, and performance with advanced pigments
          </div>
          <div className="absolute bottom-4 right-4 bg-white text-black p-4 rounded-full">
